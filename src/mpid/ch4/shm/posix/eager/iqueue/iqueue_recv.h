...
MPIDI_POSIX_eager_recv_begin(MPIDI_POSIX_eager_recv_transaction_t * transaction, int vci)
{
    ...
    transport = MPIDI_POSIX_eager_iqueue_get_transport(vci);
...
MPL_STATIC_INLINE_PREFIX void
MPIDI_POSIX_eager_recv_commit(MPIDI_POSIX_eager_recv_transaction_t * transaction, int vci)
{
