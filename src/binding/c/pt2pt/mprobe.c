...
#ifdef HAVE_ERROR_CHECKING
    mpi_errno = MPIR_Err_create_code(mpi_errno, MPIR_ERR_RECOVERABLE, __func__, __LINE__, MPI_ERR_OTHER, "**mpi_mprobe", "**mpi_mprobe %i %t %C %p %p", source, tag, comm, message, status);
#endif
